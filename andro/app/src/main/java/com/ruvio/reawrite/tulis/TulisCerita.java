...
public class TulisCerita extends AppCompatActivity {
    ...
    String judul,diskripsi, id_kategori, isi, id_user;
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch (item.getItemId()){
            case R.id.sendCerita:
                showProgress();
//
                File imageFile = new File(getImg());
                    ...
                    public void onResponse(Call<ResponseTulis> call, Response<ResponseTulis> response) {
                        if (response.isSuccessful()){
                            ...
                            if (status){
                                ...
                                Toast.makeText(getApplicationContext(), "sukses! menunggu review", Toast.LENGTH_LONG).show();
